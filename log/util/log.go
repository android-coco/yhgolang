...
func getInfoFilePath() string {
	logfile := getCurrentDirectory() + "/logs/info." + time.Now().Format("2006-01-02") + ".log"
	return logfile
}

func getErrorFilePath() string {
	logfile := getCurrentDirectory() + "/logs/error." + time.Now().Format("2006-01-02") + ".log"
	return logfile
}

func getWarnFilePath() string {
	logfile := getCurrentDirectory() + "/logs/warn." + time.Now().Format("2006-01-02") + ".log"
	return logfile
}

func getPanicFilePath() string {
	logfile := getCurrentDirectory() + "/logs/panic." + time.Now().Format("2006-01-02") + ".log"
	return logfile
}
